...
namespace WebApp
{
    public partial class Startup
    {
        ...
        private async Task OnAuthorizationCodeReceived(AuthorizationCodeReceivedNotification context)
        {
            ...
            AuthenticationResult result = await clientApp.AcquireTokenByAuthorizationCode(new[] { "Mail.Read" }, context.Code).WithSpaAuthorizationCode().ExecuteAsync();

            //Add Spa Auth Code to the Current Session
